...
function sendWelcomeEmail($email, $full_name) {
    ...
    try {
        ...
        $mail->Body = "
            ...
            <p>You have been added as a <b>Resident</b>.</p>
            <p>Please set your password here:</p>
            <a href='http://localhost/SmartCareGuardian/set_password.php?email=$email'>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        // Insert resident without password
        $stmt = $conn->prepare("INSERT INTO users (full_name, email, role, status) 
                                VALUES (?, ?, 'resident', 'pending_password')");
        ...
        $message = "<div class='alert alert-success'>Resident added! Email sent.</div>";
    }
}
?>
...
<body>
    <div class="add-wrapper">
        <div class="add-container">
            <div class="add-header">
                ...
                <h3 class="brand-font mb-3">Add New Resident</h3>
                <p class="mb-0">Invite resident to join SmartCare Guardian</p>
            </div>
            ...
            <div class="add-body">
                ...
                <div class="info-note">
                    ...
                    Resident will receive a welcome email to set their password
                </div>
    ...
    <script>
        ...
        document.getElementById('residentForm').addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i><span>Adding Resident...</span>';
