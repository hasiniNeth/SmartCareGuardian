...
if (!$user) {
    echo "<script>alert('Caregiver not found.'); window.location='manage_caregivers.php';</script>";
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($check->num_rows > 0) {
        // Email belongs to someone else — show error, don't update
        echo "<script>alert('This email address is already in use by another account. Please use a different email.');</script>";
    } else {
        ...
        if ($update->execute()) {
            echo "<script>alert('User updated successfully!'); window.location='manage_caregivers.php';</script>";
        } else {
            ...
            <div class="edit-body">
                ...
                <form method="POST" id="editForm">
                    ...
                    <div class="d-flex justify-content-between gap-3 btn-group-row">
                        <a href="manage_caregivers.php" class="btn-back">
